...
import { PatientComponent, ResourcesTableContainerComponent, EditResourceComponent, DashboardComponent } from '.';
import { AuthGaurd } from '../../misc/auth-guard';

const routes: Routes = [
  { path: 'resources/Patient', component: PatientComponent, canActivate: [AuthGaurd] },
  { path: 'resources/dashboard/:uniqueName', component: DashboardComponent, canActivate: [AuthGaurd] },
